...
impl ClaimTagReward {
    pub fn decode(data: &[u8]) -> Option<Self> {
        ...
        if discriminator != &[90, 104, 233, 219, 216, 183, 0, 2] {
            return None;
        }
...
impl ArrangeAccounts for ClaimTagReward {
    type ArrangedAccounts = ClaimTagRewardInstructionAccounts;
